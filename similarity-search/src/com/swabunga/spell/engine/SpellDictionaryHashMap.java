...
public class SpellDictionaryHashMap extends SpellDictionaryASpell {
     ...
     * Dictionary Constructor.
     * 
     * @param wordList the words list for the dictionary
     * @throws java.io.IOException indicates problems reading the words list
     *             file
     */
    public SpellDictionaryHashMap(List<String> wordList) throws IOException {
        super((File) null);
        createDictionary(wordList);
    }
    ...
    /**
     * Constructs the dictionary from a word list.
     */
    protected void createDictionary(List<String> words) throws IOException {
