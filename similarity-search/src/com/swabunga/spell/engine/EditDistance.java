...
public class EditDistance {
     ...
     */
    static final int costOfDeletingSourceCharacter = 1;
    static final int costOfInsertingSourceCharacter = 1;
    static final int costOfSubstitutingLetters = 1;
    static final int costOfSwappingLetters = 1;
    static final int costOfChangingCase = 1;
