...
public class SymSpellImpl1 implements SymSpell {

    private static final Logger logger = Logger.getLogger(SymSpellImpl1.class.getName());
    ...
    SymSpellImpl1(SymSpellBuilder builder) {
