...
import spell_checker.edit_based.FastSimilarSearch;
...
import spell_checker.trie_based.TrieWord;
...
public class TrieTesterTopK {
    ...
    private int maxDist(List<String> results, String word) {
        ...
        for (int i = 0; i < results.size(); i++) {
            ...
            int curDist = metric.EditDistance.distance(result, word);
            if (curDist > maxD) {
                maxD = curDist;
            }
