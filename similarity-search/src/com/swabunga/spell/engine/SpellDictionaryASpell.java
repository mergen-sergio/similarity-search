...
public abstract class SpellDictionaryASpell implements SpellDictionary {
    ...
    public List<Word> getSuggestions(String word, int threshold, int[][] matrix) {
        ...
        List<Word> phoneticList = getWordsFromCode(word, threshold, nearmisscodes);
        ...
        List<Word> wordlist = getWordsFromCode(word, threshold, nearmisscodes);
...
//    }
    ...
    private List<Word> getWordsFromCode(String word, int threshold, Map<String, String> codes) {
        //Configuration config = Configuration.getConfiguration();
        List<Word> result = new ArrayList<Word>();
        int[][] matrix = new int[0][0];
        final int configDistance = threshold;
